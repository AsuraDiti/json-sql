...
module.exports = function(dialect) {
	...
	dialect.blocks.add('constraintname', function(params) {
		return ((params.constraintname) ? 'constraint ' : '') + dialect.buildBlock('name', {name: params.constraintname});
	});
	...
	dialect.blocks.add('constraintlist', function(params) {
		var constrains = params.constraintlist;
		...
		result += _(constrains).map(function(col) {
						return dialect.buildTemplate('constraintdefinition', col);
					}).join(', ');
		result += ' )';
		return result;
	});
