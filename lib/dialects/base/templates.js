...
module.exports = function(dialect) {
	...
	dialect.templates.add('constraindefinition', {
		pattern: '{constrainname} {primary} {unique} {foreignkey}',
		validate: function(type, params) {
