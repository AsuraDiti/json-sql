...
var dialectsHash = {
	base: require('./dialects/base/index'),
	mssql: require('./dialects/mssql/index'),
	postgresql: require('./dialects/postgresql/index'),
	sqlite: require('./dialects/sqlite/index'),
	mysql: require('./dialects/mysql/index')
};
